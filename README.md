...
- No complex installation required; this is a client-side only application.

### Running Locally
1. Clone the repository:
   ```bash
   git clone https://github.com/yourusername/hackweek-2026-cgpa-calculator.git
   ```
...
1. **Input Subjects:** Enter subject names, credit values, and grades.
2. **Calculate SGPA:** Click the "Calculate" button to view your term performance.
3. **Simulate Future:** Use the "What-If" section to plug in projected grades and see the impact on your overall CGPA.
